...
const MiddlePage = () => {
    ...
    return <>
        ...
        <div className="w-screen h-screen">
            ...
            <div className="flex flex-col gap-y-12 items-center w-full h-full bg-yellow-300">
                ...
                <div className="flex flex-col gap-y-8 md:flex-row justify-around container mx-auto w-4/5 h-1/2 items-center md:items-start">

                    <div className="flex flex-col gap-y-3 bg-gray-100 items-center justify-evenly w-1/2 md:w-1/4 h-4/5 rounded-lg shadow-xl md:shadow-2xl">
                        <img src="/Images/bus_anima.gif" className="w-16 h-16 md:w-24 md:h-24 rounded-full border-2 border-gray-300"></img>
                        <h1 className="text-center text-sm md:text-lg tracking-wider"><span className="text-3xl font-bold relative">2000<span className="absolute -mt-4 -ml-1 text-4xl">+</span></span> <br></br>Bus locations</h1>
                    </div>
                    ...
                    <div className="flex flex-col gap-y-3 bg-gray-100 items-center justify-evenly w-1/2 md:w-1/4 h-4/5 rounded-lg shadow-2xl">
                        ...
                        <h1 className="text-center text-sm md:text-lg tracking-wider"><span className="font-bold text-3xl relative">20 Million<span className="absolute -mt-4 -ml-1 text-4xl">+</span></span> <br></br>Happy custoners globally</h1>
                    </div>

                    <div className="flex flex-col gap-y-3 bg-gray-100 items-center justify-evenly w-1/2 md:w-1/4 h-4/5 rounded-lg shadow-2xl">
                        <img src="/Images/tickets.gif" className="w-16 h-16 md:w-24 border-2 border-gray-300 md:h-24 rounded-full"></img>
                        <h1 className="text-center text-sm md:text-lg tracking-wider"><span className="font-bold text-3xl relative ">5000<span className="absolute -mt-4   -ml-1 text-4xl">+</span></span> <br></br>Tickets book everyday</h1>
                    </div>
