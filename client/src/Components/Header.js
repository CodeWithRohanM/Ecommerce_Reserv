...
const Header = () => {
    ...
    return <>
        ...
        <div className="bg-white w-full py-4 shadow-2xl">
            ...
            <div className="flex flex-col gap-y-4 md:flex-row md:justify-between w-full container mx-auto">
                ...
                <div className="flex flex-col gap-y-8 md:flex-row md:gap-x-20 items-center">
                    <NavLink to="/"><img src="/Images/icon_logo.png" className="w-14 h-14 hover:cursor-pointer hover:w-16 hover:h-16 transition-all ease-in-out duration-300"></img></NavLink>
